...
import 'package:aman_app/Views/Feedback.dart';
...
class page1states extends State<page1> {
  ...
  void initState() {
    ...
    gettitlelist.add(getlink.a1(Icon(Icons.image,size: 35,color: Colors.white),'Gallery',Gallerypreview()));
    ...
    gettitlelist.add(getlink.a1(Icon(Icons.feedback,size: 35,color: Colors.white),'Feedback',feedback()));
    super.initState();
  }
  @override
